...
import '../styles/MedicosListPage.css'; // Reusing list page styles for consistency where applicable
  ...
  React.useEffect(() => {
    ...
    const loadMedico = async () => {
      try {
        ...
        const errorMessage = err instanceof Error ? err.message : 'Erro ao carregar médico';
